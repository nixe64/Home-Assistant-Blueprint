...
Unfortunately, it has become common practice for many members in our open source community to ignore these license terms of the other members of our community in whole or in part. In my experience, they often don't even check what the license terms look like. To my great regret, I had to realize that GitHub doesn't take the licenses that seriously either (an otherwise great platform, without which the open source community would never have reached such popularity). As a multi-billion dollar company, GitHub has gotten due its popularity, they are unable to recognize and label a license that has been formulated exactly according to the license specifications (for example, GPLv3 in my case). Simply typing or copying the license text under which terms you would like to publish your work (as GitHub does it for you if you “select” a license there) does not, in most cases, meet the legal requirements to make your work available to the community under the terms of your chosen license for free use/modification. On the contrary, you allow anyone who gets to your sources (which shouldn’t be hard if they’re hosted on GitHub) to do whatever they want with them. You did mention somewhere that you thought the license is great, by copying it. But that’s just as legally effective as if I would say, “I love Marilyn Monroe”. I can't expect that this expression of my favorite Actress does have any legal impications for my intellectual property (or rather I would be very well advised not to expect it, otherwise I would be in dire need of professional help from a psychiatrist)).<br/> 
*Who knows that GitHub was bought by Microsoft and has noticed how much money Microsoft has taken into its hands for the purchase of GitHub, also knows which army of lawyers works directly or indirectly for Microsoft. This **hypothetical someone**, if he is inclined to conspiracy theories, might get the idea that this bug has not been “overlooked” without self-interest. As Microsoft used to say in Bill Gates' time: “It’s not a bug, it’s a feature.”  (Although I don’t really know if this quote is attributable to Bill Gates or to someone else in charge at Microsoft. Maybe it only made the rounds among those I want to call "those suffering and harmed by PC-DOS 1.0, Microsoft-DOS 1.0 bis 6.22, Windows 3.1 and later versions". Microsoft would have euphemistically called us "users of DOS/Windows". At least we thought we were meant when Microsoft used that formulation. But perhaps that too was a mistake, and we urgently needed professional...).In this case, if our *hypthetical someone, who is inclined to conspiracy theories and has got the idea that this bug was not "overlooked" without self-interest, the question would arise for whom this "feature" has the greatest benefit. I don’t think it would be the many fans and members of our open source community – hypothetically, of course*.

Long preface, short: I cannot and will not tolerate this behaviour when participating in this project. Well, of course, I can’t force the open source community to be more concerned with the basics of their own existence, but I can lead by example here as well. I will not accept pull requests in which it is not clear which work served as the basis for my own modification and under which conditions / license the use / modification is permitted. Your own work **must** also be provided with a copyright notice in an appropriate form that clearly states the conditions under which **you wish to make your work** available to the open source community for free use/modification (e.g. copyright comment in source code). Since I make this project (as well as all other projects) available for free use / modification under the GPLv3 license, of course, your license terms must be compatible with the GPL (but I can’t think of a license that doesn’t work right now).

I think the naming is the **least** that the members of our common open source community deserve for the hard work they have put in. As **part of this open source community** we should be **the first** to acknowledge and respect the **intellectual property of our members**. After all, we also want at least the members of our community to acknowledge and respect our intellectual property as such, although (at least I) expect from the rest of the world to abide by my terms for free use and I will enforce (hardly imaginable) breaches of the license conditions in court if necessary. It was not without reason a long struggle to establish the right to one’s own intellectual property (nearly) worldwide. If we don't follow our own rules, we can't expect anyone else to follow our rules either. So this is a concretization of the first and most important section about the expected behavior of the members of this community: **Be Respectful**
